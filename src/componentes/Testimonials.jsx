...
import RatingSummary from "./RatingSummary"; // Importa el gráfico
...
export default function Testimonials() {
  ...
  return (
    <>
              ...
              <div>
                ...
                <div className="flex mb-3">
                  {Array.from({ length: comment.stars }).map((_, i) => (
                    <FaStar
                      key={i}
                      className="text-[#d16170] mr-1 transition-transform duration-300 hover:scale-110"
                      size={22}
                    />
                  ))}
                </div>
      ...
      {/* SECCIÓN DE GRÁFICO DE CALIFICACIONES */}
      <RatingSummary />
    </>
  );
}
